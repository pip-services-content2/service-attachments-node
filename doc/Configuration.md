...
Example:
```yaml
- descriptor: "service-attachments:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
...
Example:
```yaml
- descriptor: "service-attachments:service:seneca:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 3000
...
For more information on this section read 
[Pip.Services Configuration Guide](https://github.com/pip-services/pip-services/blob/master/usage/Configuration.md#deps)
