...
var plugin = require('service-attachments-node').AttachmentsSenecaPlugin;
...
or by using [AttachmentsSenecaClient](https://github.com/pip-services-content2/client-attachments-node/NodeClientApiV1.md/#client_seneca)